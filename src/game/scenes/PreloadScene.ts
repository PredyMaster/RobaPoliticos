...
const REAL_SPRITES: Record<string, string> = {
  ...
  coin_silver: "assets/coins/coin_silver.webp",
  coin_gold: "assets/coins/coin_gold.webp",
  bill_blue: "assets/coins/bill_blue.webp",
  bill_green: "assets/coins/bill_green.webp",
  bill_pink: "assets/coins/bill_pink.webp",
  bg: "assets/bg.jpg",
