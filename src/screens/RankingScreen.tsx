  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "12px 16px 28px", flex: 1, overflowY: "auto" }}>
        {loading && (
          <p style={{ textAlign: "center", color: C.dim, marginTop: 40 }}>
            Cargando {tabLabel}…
          </p>
        )}
        {!loading && error && (
          <p style={{ textAlign: "center", color: C.error, marginTop: 40 }}>
            {error}
          </p>
        )}
    ...
    >
      <span
        style={{
          ...
          textAlign: "center",
          color: entry.rank <= 3 ? undefined : C.dim,
        }}
      >
        {medal}
      </span>
      <div>
        ...
        >
          {entry.username}
          {isMe && (
            <span style={{ fontSize: 10, marginLeft: 6, color: C.gold }}>
              ← tú
            </span>
          )}
        </p>
